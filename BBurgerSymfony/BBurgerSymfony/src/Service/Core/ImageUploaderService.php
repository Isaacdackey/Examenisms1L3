...
use App\Service\Interface\ImageUploaderInterface;
...
class ImageUploaderService implements ImageUploaderInterface
{
    ...
    public function __construct(
        ...
        $this->initializeCloudinary($cloudinaryUrl, $cloudName, $apiKey, $apiSecret);
    }

    private function initializeCloudinary(string $url, string $cloudName, string $apiKey, string $apiSecret): void
    {
    ...
    private function handleCloudinaryError(\Exception $e): void
    {
        $this->isConfigured = false;
        $this->cloudinary = null;
